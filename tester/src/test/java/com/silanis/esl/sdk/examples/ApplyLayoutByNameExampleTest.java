...
public class ApplyLayoutByNameExampleTest {
    ...
    private void validateSignatureFields(Collection<Signature> signatures) {
        for (Signature signature : signatures) {
            ...
            assertThat("Signature field size should be 2", signature.getX(), closeTo(120, TOLERANCE));
            assertThat("Signature field size should be 2", signature.getY(), closeTo(100, TOLERANCE));
